    ...
    settings: {
      ...
      guidelineInfo: {
        'esc-2024': {
          ...
          target: 'Si toma medicación, el objetivo recomendado se restaura inicialmente a 120–129/70–79 mmHg. El médico puede indicar otro objetivo según la tolerancia y las circunstancias personales.',
        },
        'aha-acc-2025': {
          title: 'Estadounidense AHA/ACC 2025',
          ...
          target: 'Si toma medicación, el objetivo recomendado se restaura inicialmente a valores inferiores a 130/80 mmHg.',
        },
        'ish-2020': {
          title: 'Internacional ISH 2020',
      ...
      serverTitle: 'Servidor autoalojado:',
      serverDesc: 'Configura la dirección IP o URL del servidor al que se conectará la aplicación.',
      serverCurrent: 'Servidor actual: {url}',
      serverChange: 'Cambiar dirección del servidor',
      patientProfile: 'Perfil del paciente:',
      fullName: 'Nombre completo:',
      fullNamePlaceholder: 'Ej. Juan Pérez',
      sexSelect: 'Selecciona una opción',
      sexMale: 'Masculino',
      sexFemale: 'Femenino',
      ...
      whiteCoatInfoTitle: 'Filtro Síndrome bata blanca',
      whiteCoatInfoUsage: 'Está pensado para personas cuyas primeras mediciones suelen aumentar por ansiedad. Puede desactivarlo cuando deje de necesitarlo; los valores originales de cada toma se conservan.',
  ...
  en: {
    ...
    guidelines: {
      ...
      ish2020: {
        ...
        categories: {
          belowThreshold: { name: 'Below home threshold', desc: 'Systolic < 135 and diastolic < 85 mmHg.' },
          aboveThreshold: { name: 'Above home threshold', desc: 'Systolic ≥ 135 or diastolic ≥ 85 mmHg.' },
        },
      },
    },
    ...
    settings: {
      ...
      guidelineInfo: {
        'esc-2024': {
          ...
          target: 'If you take medication, the recommended target is initially restored to 120–129/70–79 mmHg. Your doctor may set a different target based on tolerance and individual circumstances.',
        },
        'aha-acc-2025': {
          title: 'US AHA/ACC 2025',
          ...
          target: 'If you take medication, the recommended target is initially restored to values below 130/80 mmHg.',
        },
        'ish-2020': {
          title: 'International ISH 2020',
      ...
      serverDesc: 'Configure the IP address or URL of the server the application will connect to.',
      serverCurrent: 'Current server: {url}',
      serverChange: 'Change server address',
      patientProfile: 'Patient Profile:',
      fullName: 'Full name:',
      fullNamePlaceholder: 'e.g. John Doe',
      sexSelect: 'Select an option',
      sexMale: 'Male',
      sexFemale: 'Female',
      ...
      whiteCoatInfoTitle: 'White Coat Syndrome Filter',
      whiteCoatInfoUsage: 'It is intended for people whose first readings tend to rise because of anxiety. You can turn it off when you no longer need it; the original values of every reading are retained.',
