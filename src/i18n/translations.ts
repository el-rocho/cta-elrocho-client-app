...
export const translations = {
  es: {
    ...
    header: {
      ...
      badgeClient: 'Cliente autoalojado',
      ...
      serverHealth: {
        ...
        detailsTooltip: 'Abrir estado detallado',
      },
      serverStatus: {
        title: 'Estado del servidor',
        autoRefresh: 'Actualización automática cada 5 segundos',
        refresh: 'Actualizar ahora',
        close: 'Cerrar estado del servidor',
        loading: 'Consultando el servidor...',
        unavailable: 'No se ha podido actualizar la información del servidor.',
        'unsupported-version': 'Los servidores versión 1.6.0 no admiten información detallada.',
        serviceAvailable: 'Servidor disponible',
        databaseAvailable: 'Base de datos operativa',
        version: 'Versión',
        uptime: 'En funcionamiento',
        latency: 'Latencia de conexión',
        cpuProcess: 'CPU del proceso',
        logicalCores: '{count} núcleos lógicos disponibles',
        calculating: 'Calculando...',
        memoryContainer: 'RAM del contenedor',
        memoryProcess: 'RAM del proceso',
        usedOf: '{used} de {total}',
        processUsed: '{used} utilizados por el proceso',
        diskData: 'Disco de datos',
        freeSpace: '{free} libres',
        notAvailable: 'No disponible',
        database: 'Base de datos',
        databaseSize: 'Tamaño SQLite',
        databaseResponse: 'Respuesta interna',
        lastBackup: 'Última copia',
        lastFullBackup: 'Última copia completa',
        never: 'No registrada',
        apiActivity: 'Actividad de la API',
        requestsLastMinute: 'Solicitudes en el último minuto',
        averageResponse: 'Respuesta media',
        received: 'Datos recibidos',
        sent: 'Datos enviados',
        scopeNote: 'CPU y RAM corresponden al proceso o contenedor de la aplicación. La actividad de red incluye solamente el tráfico de la API.',
    ...
    form: {
      ...
      systolicShort: 'Sist',
      diastolicShort: 'Diast',
      heartRateShort: 'Pulso',
      armLabel: 'Brazo:',
      armLeft: 'Izquierdo',
      armRight: 'Derecho',
      ...
      measurementGuideAdviceTitle: 'Consejos:',
      measurementGuideMorningEvening: 'Toma mediciones de Mañana (antes del desayuno) y Tarde (antes de la cena).',
      ...
      measurementGuideFollowUpTitle: 'Para seguimiento:',
      measurementGuideFollowUp: 'Sigue el patrón recomendado por tu médico (diarias, semanales...).',
      measurementGuideAssessmentTitle: 'Para valoración:',
      measurementGuideAssessment: 'Mínimo tres días seguidos, mejor siete si la media de todas las lecturas está cerca del umbral recomendado.',
    },
    ...
    trend: {
      ...
      maximum: 'Máxima',
      minimum: 'Mínima',
      percentileBelow: '90 % debajo de',
      percentileAbove: '90 % encima de',
      guidelineMode: 'Guía (moda)',
      targetMode: 'Objetivo (moda)',
      trendCardTitle: 'Tendencia',
      lastMonth: 'Último mes',
      trendValues: 'Valores de tendencia',
      patternValues: 'Valores de patrón',
      notAvailable: 'No disponible',
      noPredominant: 'Sin predominio',
      showDetails: 'Más datos',
      hideDetails: 'Menos datos',
      sysShort: 'Sistólica',
      diaShort: 'Diastólica',
      bpmShort: 'Pulsaciones',
      sessionAverage: 'Promedio sesión',
      noData: 'Sin datos en el rango seleccionado',
      complementaryMetrics: 'Métricas complementarias',
      homePressureLoad: 'Mediciones ≥135/85',
      estimatedMap: 'Presión Arterial Media',
      averagePulsePressure: 'Presión Pulso Media',
      loadFraction: '{elevated} de {total} sesiones',
      insufficientMetricsData: 'Sin datos',
      metricsInfoTooltip: 'Información sobre carga presiva, presión arterial media y presión de pulso',
      metricsInfoTitle: 'Métricas cardiovasculares complementarias',
      pressureLoadTitle: 'Carga Presiva',
      pressureLoadDescription: 'Es el porcentaje de medidas con valores de Sistólica ≥135 o Diastólica ≥85 mmHg. Sirve para dar una idea rápida de si la tensión está controlada la mayor parte del tiempo.',
      pressureLoadRequirement: 'Se necesitan al menos seis mediciones válidas distribuidas en tres días para considerarse representativa.',
      totalLoad: 'Total',
      systolicLoad: 'Sistólica ≥135',
      diastolicLoad: 'Diastólica ≥85',
      sessionsAndDays: '{sessions} sesiones en {days} días',
      mapTitle: 'Presión arterial media estimada',
      mapDescription: 'Es un valor informativo y debe ser interpretado por un profesional médico. Calcula un valor de tensión arterial a partir de la Sistólica y la Diastólica que representa la presión arterial a la que está sometido nuestro cuerpo la mayor parte del tiempo.',
      mapFormula: 'PAM estimada = Diastólica + (Sistólica − Diastólica) / 3',
      pulsePressureTitle: 'Presión de pulso media',
      pulsePressureDescription: 'Es la diferencia entre la presión Sistólica y la Diastólica. El valor mostrado es la media de las sesiones efectivas del periodo seleccionado.',
      pulsePressureFormula: 'PP = Sistólica − Diastólica',
      pulsePressureContext: 'Es una métrica complementaria cuya interpretación depende especialmente de la edad y del contexto clínico. No constituye por sí sola un diagnóstico ni un objetivo terapéutico.',
      includedSessions: '{sessions} sesiones efectivas',
      metricsCaution: 'Datos del periodo seleccionado. No deben interpretarse como un diagnóstico.',
      categories: {
    ...
    list: {
      ...
      presetAll: 'Todo',
      expandHistory: 'Mostrar historial',
      collapseHistory: 'Ocultar historial',
    ...
    settings: {
      ...
      guidelineNone: 'Sin etiquetas ni avisos',
      ...
      medicationYes: 'SÍ toma',
      medicationNo: 'NO toma',
    ...
    data: {
      ...
      lastBackup: 'Última copia confirmada',
      backupNever: 'Ninguna confirmada',
      createBackupNow: 'Crear una copia (JSON)',
      restoreBackup: 'Restaurar una copia',
      ...
      scheduleNotice: 'La aplicación debe estar abierta. Cuando venza el plazo, mostrará un recordatorio para que descargues la copia; no puede ejecutarse con la aplicación cerrada. El plazo solo se reinicia cuando confirmas que el archivo se ha guardado.',
    ...
    legal: {
      ...
      medicalTitle: 'Información y límites de uso',
      medicalPurpose: 'La aplicación se ha diseñado exclusivamente para el registro y seguimiento personal de mediciones domiciliarias, no debe ser utilizada en ningún caso para efectuar diagnósticos ni modificar tratamientos prescritos por un facultativo.',
      profilesIntro: 'Permite elegir entre tres perfiles de referencia:',
      profileEsc: 'Guía europea ESC 2024',
      profileAha: 'Guía estadounidense AHA/ACC 2025',
      profileIsh: 'Guía internacional ISH 2020.',
      medicalLimits: 'Los perfiles no modifican las mediciones realizadas, sólo afectan a las etiquetas, tendencias, objetivos y avisos mostrados; pero no reproducen íntegramente dichas guías y no constituyen ningún diagnóstico.',
      medicationWarning: 'No inicie, suspenda ni modifique un tratamiento basándose en la aplicación. Consulte siempre a un profesional sanitario.',
      ...
      storageLabel: 'Aplicación cliente:',
      storageText: 'Esta aplicación envía credenciales, mediciones, perfil, notas y configuración al servidor autoalojado configurado por el usuario. Conserva en el dispositivo información de sesión y una caché local necesaria para su funcionamiento.',
      networkLabel: 'Comunicaciones:',
      networkText: 'La aplicación no recopila, transmite ni comparte datos con terceros, tampoco incluye publicidad ni servicios de analítica o seguimiento. Comunica exclusivamente con el servidor configurado y con las fuentes externas que el usuario decida abrir.',
      ...
      filesTitle: 'Copias, exportaciones e importaciones',
      filesText: 'Las copias y los informes generados contienen mediciones, datos de perfil y notas de salud. Al descargarlos o compartirlos salen del servidor y quedan almacenados en el dispositivo bajo el control y la responsabilidad del usuario.',
      restoreText: 'Restaurar o importar datos puede sustituir total o parcialmente datos actuales.',
      responsibilityNote: 'Este aviso no sustituye la información de privacidad y seguridad que, en su caso, deba facilitar quien administre la instalación del servidor.',
    },
    ...
    toast: {
      ...
      confirmBackupSaved: 'Confirmar copia guardada',
      backupCancelledAction: 'Copia cancelada',
      manualBackupSaved: 'Copia guardada correctamente.',
      manualBackupSavedAt: 'Copia guardada en {path}',
      manualBackupCancelled: 'No se ha guardado ninguna copia.',
      manualBackupSuccess: '✓ Copia confirmada. Se ha actualizado la fecha del recordatorio.',
      manualBackupError: 'No se pudo iniciar la descarga de la copia.',
    ...
    pdfReport: {
      title: 'INFORME TENSIÓN ARTERIAL DOMICILIARIA',
  ...
  en: {
    ...
    header: {
      ...
      badgeClient: 'Self-hosted client',
      ...
      serverHealth: {
        ...
        detailsTooltip: 'Open detailed status',
      },
      serverStatus: {
        title: 'Server status',
        autoRefresh: 'Automatically refreshed every 5 seconds',
        refresh: 'Refresh now',
        close: 'Close server status',
        loading: 'Checking the server...',
        unavailable: 'The server information could not be refreshed.',
        'unsupported-version': 'Servers running version 1.6.0 do not support detailed information.',
        serviceAvailable: 'Server available',
        databaseAvailable: 'Database operational',
        version: 'Version',
        uptime: 'Uptime',
        latency: 'Connection latency',
        cpuProcess: 'Process CPU',
        logicalCores: '{count} logical cores available',
        calculating: 'Calculating...',
        memoryContainer: 'Container RAM',
        memoryProcess: 'Process RAM',
        usedOf: '{used} of {total}',
        processUsed: '{used} used by the process',
        diskData: 'Data disk',
        freeSpace: '{free} free',
        notAvailable: 'Not available',
        database: 'Database',
        databaseSize: 'SQLite size',
        databaseResponse: 'Internal response',
        lastBackup: 'Latest backup',
        lastFullBackup: 'Latest full backup',
        never: 'Not recorded',
        apiActivity: 'API activity',
        requestsLastMinute: 'Requests in the last minute',
        averageResponse: 'Average response',
        received: 'Data received',
        sent: 'Data sent',
        scopeNote: 'CPU and RAM refer to the application process or container. Network activity includes API traffic only.',
    ...
    form: {
      ...
      measurementGuideMorningEvening: 'Take measurements in the Morning (before breakfast) and Evening (before dinner).',
      ...
      measurementGuideFollowUpTitle: 'For monitoring:',
      measurementGuideFollowUp: 'Follow the schedule recommended by your doctor (daily, weekly...).',
      measurementGuideAssessmentTitle: 'For assessment:',
      measurementGuideAssessment: 'At least three consecutive days, preferably seven if the average of all readings is close to the recommended threshold.',
    },
    ...
    trend: {
      ...
      maximum: 'Maximum',
      minimum: 'Minimum',
      percentileBelow: '90% below',
      percentileAbove: '90% above',
      guidelineMode: 'Guideline (mode)',
      targetMode: 'Target (mode)',
      trendCardTitle: 'Trend',
      lastMonth: 'Last month',
      trendValues: 'Trend values',
      patternValues: 'Pattern values',
      notAvailable: 'Not available',
      noPredominant: 'No predominant value',
      showDetails: 'More data',
      hideDetails: 'Less data',
      sysShort: 'Systolic',
      diaShort: 'Diastolic',
      bpmShort: 'Pulse',
      sessionAverage: 'Session average',
      noData: 'No data in selected range',
      complementaryMetrics: 'Complementary metrics',
      homePressureLoad: 'Readings ≥135/85',
      estimatedMap: 'Mean Arterial Pressure',
      averagePulsePressure: 'Mean Pulse Pressure',
      loadFraction: '{elevated} of {total} sessions',
      insufficientMetricsData: 'No data',
      metricsInfoTooltip: 'Information about home pressure load, mean arterial pressure and pulse pressure',
      metricsInfoTitle: 'Complementary cardiovascular metrics',
      pressureLoadTitle: 'Pressure Load',
      pressureLoadDescription: 'It is the percentage of readings with Systolic ≥135 or Diastolic ≥85 mmHg. It provides a quick indication of whether blood pressure is controlled most of the time.',
      pressureLoadRequirement: 'At least six valid readings across three days are needed for it to be considered representative.',
      totalLoad: 'Total',
      systolicLoad: 'Systolic ≥135',
      diastolicLoad: 'Diastolic ≥85',
      sessionsAndDays: '{sessions} sessions over {days} days',
      mapTitle: 'Estimated mean arterial pressure',
      mapDescription: 'It is an informational value and should be interpreted by a medical professional. It calculates a blood pressure value from Systolic and Diastolic pressure that represents the arterial pressure to which our body is exposed most of the time.',
      mapFormula: 'Estimated MAP = Diastolic + (Systolic − Diastolic) / 3',
      pulsePressureTitle: 'Mean pulse pressure',
      pulsePressureDescription: 'It is the difference between Systolic and Diastolic pressure. The value shown is the mean of the effective sessions in the selected period.',
      pulsePressureFormula: 'PP = Systolic − Diastolic',
      pulsePressureContext: 'It is a complementary metric whose interpretation depends especially on age and clinical context. On its own, it is neither a diagnosis nor a treatment target.',
      includedSessions: '{sessions} effective sessions',
      metricsCaution: 'Data from the selected period. They must not be interpreted as a diagnosis.',
      categories: {
    ...
    trendInsights: {
      title: 'Trend over the last month',
      insufficientTitle: 'Insufficient data',
      patternTitle: 'Pattern:',
      noPatternTitle: 'No predominant pattern',
    ...
    settings: {
      ...
      guidelineNone: 'No labels or notices',
      ...
      medicationYes: 'YES takes',
      medicationNo: 'NO takes',
    ...
    data: {
      ...
      lastBackup: 'Last confirmed backup',
      backupNever: 'None confirmed',
      createBackupNow: 'Create a backup (JSON)',
      ...
      scheduleNotice: 'The application must be open. When due, it will show a reminder so you can download the backup; it cannot run while the application is closed. The period only restarts after you confirm that the file was saved.',
    ...
    legal: {
      ...
      medicalTitle: 'Information and limitations of use',
      medicalPurpose: 'The application has been designed exclusively for recording and personally monitoring home measurements. It must never be used to make diagnoses or change treatments prescribed by a physician.',
      profilesIntro: 'It lets you choose among three reference profiles:',
      profileEsc: 'European ESC 2024 guideline',
      profileAha: 'US AHA/ACC 2025 guideline',
      profileIsh: 'International ISH 2020 guideline.',
      medicalLimits: 'The profiles do not alter the measurements taken; they only affect the labels, trends, targets, and notices shown. They do not reproduce those guidelines in full and do not constitute a diagnosis.',
      medicationWarning: 'Do not start, stop, or change treatment based on the application. Always consult a healthcare professional.',
      ...
      storageLabel: 'Client application:',
      storageText: 'This application sends credentials, measurements, profile details, notes, and settings to the self-hosted server configured by the user. It keeps session information and a local cache on the device as required for operation.',
      networkLabel: 'Communications:',
      networkText: 'The application does not collect, transmit, or share data with third parties, and includes no advertising, analytics, or tracking services. It communicates exclusively with the configured server and with external sources the user chooses to open.',
      ...
      filesTitle: 'Backups, exports, and imports',
      filesText: 'Generated backups and reports contain measurements, profile details, and health notes. Once downloaded or shared, they leave the server and are stored on the device under the user’s control and responsibility.',
      restoreText: 'Restoring or importing data may replace current data in whole or in part.',
      responsibilityNote: 'This notice does not replace the privacy and security information that the server installation administrator may be required to provide.',
    },
    ...
    toast: {
      ...
      confirmBackupSaved: 'Confirm backup saved',
      backupCancelledAction: 'Backup cancelled',
      manualBackupSaved: 'Backup saved successfully.',
      manualBackupSavedAt: 'Backup saved in {path}',
      manualBackupCancelled: 'No backup was saved.',
      manualBackupSuccess: '✓ Backup confirmed. The reminder date has been updated.',
      manualBackupError: 'The backup download could not be started.',
    ...
    pdfReport: {
      title: 'HOME BLOOD PRESSURE REPORT',
